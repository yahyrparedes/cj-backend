    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(blank=True, max_length=254)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commons.country')),
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commons.district')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commons.region')),
                ('sub_region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commons.subregion')),
            ],
            options={
